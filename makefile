...
docker:
	GOOS=linux GOARCH=amd64 $(GOBUILD)
	docker build -t drone/webhook . --tag registry.cn-shanghai.aliyuncs.com/zzf2001/bark-webhook
	docker push registry.cn-shanghai.aliyuncs.com/zzf2001/bark-webhook